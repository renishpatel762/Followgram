    ...
    return (
        <div>
            ...
            <div className="min-h-screen px-2 dark:text-white dark:bg-gray-800">
                ...
                <div className="flex border-2 border-black text-black">
                    {/* <p className="">Hello </p> */}
                    <input className="" type="text" placeholder="search" onChange={handleSearchTermChange}
                    ...
                    isSearchData
                        ...
                        <div>
                            <div className="flex justify-evenly mt-10">
                                <p
                                    className={`mx-2 text-2xl cursor-pointer ${searchCategory !== "Recent" ? "" : "border-blue-400 border-b-2"
                                        }`}
                                    onClick={() => {
                                ...
                                <p
                                    className={`mx-2 text-2xl cursor-pointer ${searchCategory !== "Accounts" ? "" : "border-blue-400 border-b-2"
                                        }`}
                                    onClick={() => {
                                ...
                                <p
                                    className={`mx-2 text-2xl cursor-pointer ${searchCategory !== "Media" ? "" : "border-blue-400 border-b-2"
                                        }`}
                                    onClick={() => {
                                ...
                                <p
                                    className={`mx-2 text-2xl cursor-pointer ${searchCategory !== "TextPost" ? "" : "border-blue-400 border-b-2"
                                        }`}
                                    onClick={() => {
                                    ...
                                    <>
                                        {
                                            resultData.length > 0
                                                ...
                                                resultData.map(acitem => (
                                                    <div className="flex m-5 cursor-pointer" key={acitem._id} onClick={() => {
                                                        ...
                                                        />
                                                        <div>
                                                            <p className="pl-1">{acitem.name}</p>
